	...
	([
		...
		(function(module, exports, __webpack_require__) {
			...
			var Shape = function(_Graphics) {
				...
				function Shape() {
					...
					return _possibleConstructorReturn(this, (Shape.__proto__ || Object.getPrototypeOf(Shape)).apply(this,
						arguments));
				}
			...
			var Group = function(_DisplayObject) {
				...
				_createClass(Group, [{
					...
					value: function destroy() {
						...
						this.parent && _get(Group.prototype.__proto__ || Object.getPrototypeOf(Group.prototype), 'destroy', this)
							.call(this);
					}
				}]);
		...
		(function(module, exports, __webpack_require__) {
			...
			var DisplayObject = function(_EventDispatcher) {
				...
				function DisplayObject() {
					...
					var _this = _possibleConstructorReturn(this, (DisplayObject.__proto__ || Object.getPrototypeOf(DisplayObject))
						.call(this));
		...
		(function(module, exports, __webpack_require__) {
			...
			(function(global) {
				...
				function getGlobal() {
					if ((typeof global === 'undefined' ? 'undefined' : _typeof(global)) !== 'object' || !global || global.Math !==
						Math || global.Array !== Array) {
			...
			(function(process) {
				...
				TWEEN.Tween.prototype = {
					...
					start: function start(time) {
						...
						this._startTime = time !== undefined ? typeof time === 'string' ? TWEEN.now() + parseFloat(time) : time :
							TWEEN.now();
							...
							if (this._repeat > 0) {
								...
								for (property in this._valuesStartRepeat) {
									if (typeof this._valuesEnd[property] === 'string') {
										this._valuesStartRepeat[property] = this._valuesStartRepeat[property] + parseFloat(this._valuesEnd[
											property]);
									}
			...
			var Renderer = function() {
				...
				_createClass(Renderer, [{
					...
					value: function update(stage) {
						...
						// console.log(this.renderer.render, 'canvasCallback')
						//绘制
						console.log("ctx.draw");
						this.ctx.draw && this.ctx.draw(false, function(res) {
							setTimeout(function() {
								canvasCallback();
							}, 500);
						});
		...
		(function(module, exports, __webpack_require__) {
			...
			var WeStage = function(_Group) {
				...
				function WeStage(width, height, id, {
					page,
					component,
					callback
				}) {
					...
					// console.log(page, component, callback, 'WeStagecallback')
					var canvasId = component.getCaxCanvasId();
					var ctx = uni.createCanvasContext(canvasId, component);
					var hitCtx = uni.createCanvasContext(canvasId + 'Hit', component);
				...
				_createClass(WeStage, [{
					...
					value: function touchEndHandler(evt) {
						...
						this._getObjectUnderPoint(evt, function(obj) {
							...
							if (obj && Math.abs(_this4._mouseDownX - _this4._mouseUpX) < 30 && Math.abs(_this4._mouseDownY -
									_this4._mouseUpY) < 30) {
								mockEvt.type = 'tap';
								obj.dispatchEvent(mockEvt);
							}
		...
		(function(module, exports, __webpack_require__) {
			...
			var RoundedRect = function(_Shape) {
				...
				function RoundedRect(width, height, r, option) {
					...
					var _this = _possibleConstructorReturn(this, (RoundedRect.__proto__ || Object.getPrototypeOf(RoundedRect)).call(
						this));
			...
			var Stage = function(_Group) {
				...
				function Stage(width, height, renderTo) {
					...
					if (len === 0) {
						...
						// weapp
						return _ret = new _weStage2.default(arguments[0], arguments[1], arguments[2], arguments[3]),
							_possibleConstructorReturn(_this, _ret);
					} else {
						if (len === 1) {
							_this.canvas = typeof width === 'string' ? document.querySelector(width) : width;
						} else {
							// console.log(renderTo,'1renderTo')
							const {
								selecter,
								callback
							} = renderTo
							_this.renderTo = typeof selecter === 'string' ? document.querySelector('.poster-canvas canvas') : selecter;
							_this.renderTo.style = '';
				...
				_createClass(Stage, [{
					...
					value: function _handleMouseUp(evt) {
						...
						if (obj && evt.type === 'touchend' && Math.abs(this._mouseDownX - this._mouseUpX) < 30 && Math.abs(this._mouseDownY -
								this._mouseUpY) < 30) {
							mockEvt.type = 'tap';
							obj.dispatchEvent(mockEvt);
						}
					...
					value: function _getOffset(el) {
						...
						return [_l + Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), _t + Math.max(
		...
		(function(module, exports, __webpack_require__) {
			...
			var CanvasRender = function(_Render) {
				...
				function CanvasRender(canvasOrContext, width, height) {
					...
					var _this = _possibleConstructorReturn(this, (CanvasRender.__proto__ || Object.getPrototypeOf(CanvasRender)).call(
						this));
				...
				_createClass(CanvasRender, [{
					...
					value: function render(ctx, o, cacheData) {
						// console.log(ctx, o, cacheData, 'render')
						var mtx = o._matrix;
						if (o.children) {
					...
					value: function _render(ctx, o, mtx, cacheData, inGroup) {
						...
						if (ocg) {
							...
							ocg._matrix.appendTransform(ocg.x, ocg.y, ocg.scaleX, ocg.scaleY, ocg.rotation, ocg.skewX, ocg.skewY,
								ocg.originX, ocg.originY);
							ctx.setTransform(ocg._matrix.a, ocg._matrix.b, ocg._matrix.c, ocg._matrix.d, ocg._matrix.tx, ocg._matrix
								.ty);
							ocg.render(ctx);
						...
						if (oacg) {
							...
							oacg._matrix.appendTransform(oacg.x, oacg.y, oacg.scaleX, oacg.scaleY, oacg.rotation, oacg.skewX, oacg.skewY,
								oacg.originX, oacg.originY);
							ctx.setTransform(oacg._matrix.a, oacg._matrix.b, oacg._matrix.c, oacg._matrix.d, oacg._matrix.tx, oacg._matrix
								.ty);
							oacg.render(ctx);
						...
						if (o._readyToCache || o.cacheUpdating) {
							...
							if (o._readyToFilter) {
								o.cacheCtx.putImageData((0, _index.filter)(o.cacheCtx.getImageData(0, 0, o.cacheCanvas.width, o.cacheCanvas
									.height), o._filterName), 0, 0);
		...
		(function(module, exports, __webpack_require__) {
			...
			var HitRender = function(_Render) {
				...
				function HitRender() {
					...
					var _this = _possibleConstructorReturn(this, (HitRender.__proto__ || Object.getPrototypeOf(HitRender)).call(
						this));
				...
				_createClass(HitRender, [{
					...
					value: function hitPixel(o, evt) {
						...
						for (var i = l - 1; i >= 0; i--) {
							var child = list[i];
							mtx.initialize(1, 0, 0, 1, 0, 0);
							mtx.appendTransform(o.x - evt.stageX, o.y - evt.stageY, o.scaleX, o.scaleY, o.rotation, o.skewX, o.skewY,
								o.originX, o.originY);
							// if (!this.checkBoundEvent(child)) continue
							ctx.save();
		...
		(function(module, exports, __webpack_require__) {
			...
			var WxHitRender = function(_Render) {
				...
				function WxHitRender(ctx, component, canvasId) {
					...
					var _this = _possibleConstructorReturn(this, (WxHitRender.__proto__ || Object.getPrototypeOf(WxHitRender)).call(
						this));
				...
				_createClass(WxHitRender, [{
					...
					value: function hit(list, evt, cb, current) {
						...
						ctx.save();
						mtx.appendTransform(obj.x - evt.stageX, obj.y - evt.stageY, obj.scaleX, obj.scaleY, obj.rotation, obj.skewX,
							obj.skewY, obj.originX, obj.originY);
		...
		(function(module, exports, __webpack_require__) {
			...
			var ArrowPath = function(_Shape) {
				...
				function ArrowPath(path, option) {
					...
					var _this = _possibleConstructorReturn(this, (ArrowPath.__proto__ || Object.getPrototypeOf(ArrowPath)).call(
						this));
							...
							switch (action) {
								...
								case 'S':
									...
									if (preItem[0] === 'C' || preItem[0] === 'c') {
										this.bezierCurveTo(preX + preItem[5] - preItem[3], preY + preItem[6] - preItem[4], item[1], item[2],
											item[3], item[4]);
									} else if (preItem[0] === 'S' || preItem[0] === 's') {
										this.bezierCurveTo(preX + preItem[3] - preItem[1], preY + preItem[4] - preItem[2], item[1], item[2],
											item[3], item[4]);
									}
									preX = item[3];
									preY = item[4];
								...
								case 'v':
									...
									break;
								case 'c':
									this.bezierCurveTo(preX + item[1], preY + item[2], preX + item[3], preY + item[4], preX + item[5],
										preY + item[6]);
									preX = preX + item[5];
									preY = preY + item[6];
									break;
								case 's':
									if (preItem[0] === 'C' || preItem[0] === 'c') {
										this.bezierCurveTo(preX + preItem[5] - preItem[3], preY + preItem[6] - preItem[4], preX + item[1],
											preY + item[2], preX + item[3], preY + item[4]);
									} else if (preItem[0] === 'S' || preItem[0] === 's') {
										this.bezierCurveTo(preX + preItem[3] - preItem[1], preY + preItem[4] - preItem[2], preX + item[1],
											preY + item[2], preX + item[3], preY + item[4]);
									}
								...
								case 't':
									if (preItem[0] === 'Q' || preItem[0] === 'q') {
										...
										this.quadraticCurveTo(preX, preY, preX + preX - preCX, preY + preY - preCY, preX + item[1], preY +
											item[2]);
										preCX = preX + preX - preCX;
										preCY = preY + preY - preCY;
									}
		...
		(function(module, exports, __webpack_require__) {
			...
			var getArcCenter = function getArcCenter(px, py, cx, cy, rx, ry, largeArcFlag, sweepFlag, sinphi, cosphi, pxp,
				pyp) {
			...
			var Button = function(_Group) {
				...
				function Button(option) {
					...
					if (option.text) {
						...
						if (textWidth > option.width) {
							...
							textList.forEach(function(text, index) {
								...
								_this.text.y = Math.max(textHeight, option.height) / 2 - 10 + 5 * _this.text.scaleY + (option.textY || 0) +
									index * 12 - textHeight / 2 + lineHeight / 2;
					...
					if (option.bgImage) {
						...
						_this.roundedRect = new _roundedRect2.default(option.width, option.autoHeight ? Math.max(textHeight, option.height) :
							option.height, option.borderRadius, {
		...
		(function(module, exports, __webpack_require__) {
			...
			var EquilateralPolygon = function(_Shape) {
				...
				function EquilateralPolygon(num, r, options) {
					...
					var _this = _possibleConstructorReturn(this, (EquilateralPolygon.__proto__ || Object.getPrototypeOf(
						EquilateralPolygon)).call(this));
