<template>
	<view class="body" :style="themeColor">
		<view class="J-weixin-tip weixin-tip" :class="{'show':display}">
			<view class="weixin-tip-content">
				请在菜单中选择在浏览器中打开,<br />
				以完成支付
			</view>
		</view>
		<view class="J-weixin-tip-img weixin-tip-img" :class="[className,{'show':display}]"></view>
	</view>
</template>
			...
			if (location.hash.indexOf('error') != -1) {
				...
				if (ua.indexOf('micromessenger') != -1) {
					...
					let base64 = new this.$util.Base64(),
						param = options.goto;
					location.href = param ? base64.decode(options.goto) : location.href + '#error';
