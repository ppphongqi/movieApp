			...
			<view class="business-card">
				<view style="display: flex;">
					...
					<view class="business-card__content">
						...
						<view class="business-card__row">
							<view class="business-card__text is-bg">{{item.address}}</view>
						</view>
					</view>
				</view>
				<view class="business-card__row" style="margin-top: 20rpx;">
					...
					<button class="business-card__footer__btn btn-normal" @click.stop="handleBtnMapNavClick({latitude:item.latitude,longitude:item.longitude,name: item.addressName,address:item.address})">
						<image class="business-card__footer__img" src="../static/images/icon-location.png"></image>导航：{{item.distanceStr}}
					</button>
				</view>
			</view>
		</view>
