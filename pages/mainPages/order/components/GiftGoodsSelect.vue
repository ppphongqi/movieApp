<template>
	<view class="c-GiftGoodsSelect app-card">
		<!-- header -->
		<view class="app-flex app-flex--align-center">
			<view class="m-btm30 app-flex-item app-flex-item--1 f-32 f-bold col-3">
				{{title}}
			</view>
		...
		<!-- header end -->
		<!-- content -->
		<view class="c-GiftGoodsSelect__content">
				...
				<view v-for="(item,index) in list" :key="item.id" class="c-GiftGoodsSelect-item app-card" :class="{
					...
					<view class="app-flex app-flex--align-center m-top20">
						<view class="app-flex-item" style="font-size: 0;">
							<view class="iconfont is-inline icon-zhuyi"></view>
						</view>
						<view class="app-flex-item app-flex-item--1 f-24 col-9" style="margin-left: 12rpx;">
